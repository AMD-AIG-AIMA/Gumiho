...
parser.add_argument('--outdir', type=str, default='default_dir')
...
for i in range(num_p):
    ...
    if i == 0:
        command = "CUDA_VISIBLE_DEVICES=0,1,2,3 python gumiho/ge_data/ge_data_all_llama3.py --start={} --end={} --index={} --gpu_index {} --outdir {}".format(start, end, index,
                                                                                                    gpu_index_str, outdir)
    elif i == 1:
        command = "CUDA_VISIBLE_DEVICES=4,5,6,7 python gumiho/ge_data/ge_data_all_llama3.py --start={} --end={} --index={} --gpu_index {} --outdir {}".format(start, end, index,
                                                                                                    gpu_index_str, outdir)
